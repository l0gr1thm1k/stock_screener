...
class AlphaVantage:
    ...
    def daily_returns(self, ticker, output='compact'):
        """
        ...
        :param output: The output type that AlphaVantage should return. Defaults to compact, other values include...
        :return json_response: Return a json object with the daily return data.
        """
        base_url = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol={}&outputsize={}&apikey={}"
        formatted_url = base_url.format(ticker, output, self.key)
